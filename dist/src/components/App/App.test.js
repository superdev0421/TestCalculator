...
const testInput = (btnGroup, expr) =>
  __awaiter(void 0, void 0, void 0, function* () {
    for (let ch of expr) {
      if (ch >= "0" && ch <= "9") {
        btnGroup.numBtn[Number(ch)].simulate("click");
      }
      if (ch === "+") yield btnGroup.plusBtn.simulate("click");
      if (ch === "-") yield btnGroup.minusBtn.simulate("click");
      if (ch === "*") yield btnGroup.timesBtn.simulate("click");
      if (ch === "/") yield btnGroup.divBtn.simulate("click");
      if (ch === "=") yield btnGroup.eqBtn.simulate("click");
...
describe("test calculation", () => {
  ...
  it("test plus", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      yield (0,
      react_1.waitFor)(() => expect(mockedAxios.get).toHaveBeenCalledTimes(5));
